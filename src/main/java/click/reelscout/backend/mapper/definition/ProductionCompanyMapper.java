...
public interface ProductionCompanyMapper extends UserMapper<ProductionCompany, ProductionCompanyRequestDTO, ProductionCompanyResponseDTO, ProductionCompanyBuilder, ProductionCompanyMapper>{
}
